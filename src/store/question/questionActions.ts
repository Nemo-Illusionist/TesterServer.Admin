...
export const getQuestions = createAsync<{}, IQuestion[], Error>(
  'GET_QUESTIONS',
...
export const getQuestion = createAsync<
  string,
  IQuestion | null,
  Error
>('GET_QUESTION', async (id) => {
...
export const createQuestion = createAsync<
  IQuestionAdd,
  IQuestion,
  Error
>('CREATE_QUESTION', async (params: IQuestionAdd) => {
  const url = 'admin/v1/Question';
...
export const deleteQuestion = createAsync<void, void, Error>(
  'DELETE_QUESTION',
  async (id) => {
    const url = `admin/v1/Question/${id}`;
